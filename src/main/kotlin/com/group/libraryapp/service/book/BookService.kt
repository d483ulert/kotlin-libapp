...
import com.group.libraryapp.repository.user.loan_history.UserLoanHistroyQueryDslRepository
...
class BookService (
    ...
    private val userLoanHistoryQueryDslRepository: UserLoanHistroyQueryDslRepository
){
    @Transactional
